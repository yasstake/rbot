...
pub struct BinanceWsTradeMessage {
    ...
    pub t: u64,    // "t":3200243634           Trade ID
    pub p: String, // "p":"26132.02000000"     Price
    pub q: String, // "q":"0.00244000"         Quantity
    pub b: u64,    // "b":22161265544          Buyer order ID
    pub a: u64,    // "a":22161265465          Seller order ID
    #[serde(rename = "T")]
...
mod binance_message_test {
    use crate::exchange::binance::message::{BinanceTradeMessage, BinanceWsBoardUpdate};
